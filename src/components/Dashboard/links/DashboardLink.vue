...
<main class="flex-1 overflow-y-auto bg-blue-50 p-6">
    ...
    <div class="max-w-7xl mx-auto">
      <h2 class="text-3xl font-bold text-gray-900">Welcome back, Traveler!</h2>
          ...
          <div class="px-4 py-5 sm:p-6">
            <div class="flex items-center">
              <div class="flex-shrink-0">
                <img :src="trip.image" :alt="trip.destination" class="h-12 w-12 rounded-full" />
              </div>
              <div class="ml-5 w-0 flex-1">
                <h3 class="text-lg font-medium text-gray-900 truncate">{{ trip.destination }}</h3>
...
const quickStats = [
{ name: 'Total Trips', value: '12', icon: MapIcon },
{ name: 'Upcoming Trips', value: '3', icon: CalendarIcon },
{ name: 'Travel Budget', value: '$5,000', icon: CurrencyDollarIcon },
{ name: 'Travel Buddies', value: '8', icon: UserGroupIcon },
]
